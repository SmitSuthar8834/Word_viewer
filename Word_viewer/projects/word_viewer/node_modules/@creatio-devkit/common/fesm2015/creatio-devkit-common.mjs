...
const DesignerToolGroupType = Object.assign(Object.assign({}, ViewElementDataGroupType), ViewElementGroupType);
...
class HandlersOrderComparer {
    constructor(_request) {
        ...
        const scopesOrderEntries = [...((_a = this._request.scopes) !== null && _a !== void 0 ? _a : [])].reverse().map((scope, index) => [scope, index]);
...
class InternalHandlerChain {
    constructor() {
        ...
        this.handlerChain$ = {
             ...
             * @hostPublicApi
             */
            process: (request) => __awaiter(this, void 0, void 0, function* () {
                const handler = this._getHandler(request);
                this._requestListeners.forEach((listener) => listener === null || listener === void 0 ? void 0 : listener(request));
                return handler === null || handler === void 0 ? void 0 : handler.handle(request);
            }),
            /**
             * @hostPublicApi
             */
            register: (info) => {
                ...
                return () => {
                    ...
                    if (index > -1) {
                        ...
                        console.warn(`${info === null || info === void 0 ? void 0 : info.requestType} not found to unsubscribe`);
                    }
                };
            },
            /**
    ...
    clearContextedHandlersCache(contextId) {
        var _a;
        const configs = (_a = this._handlersScopesByContextId.get(contextId)) !== null && _a !== void 0 ? _a : [];
        return configs.every(({ requestType, scope }) => { var _a; return (_a = this._handlersCache.get(requestType)) === null || _a === void 0 ? void 0 : _a.delete(scope); });
    }
    _getHandler(request) {
    ...
    _getCacheScopesKey(request) {
        var _a, _b;
        const injectionContextKey = (_b = (_a = this._getInjectionContext(request === null || request === void 0 ? void 0 : request.$context)) === null || _a === void 0 ? void 0 : _a.id) !== null && _b !== void 0 ? _b : '';
        return (request.scopes || ['']).join('_').concat(injectionContextKey);
    }
    _getInjectionContext(viewModel) {
        return ((viewModel === null || viewModel === void 0 ? void 0 : viewModel['_injectionContext']) ||
            ((viewModel === null || viewModel === void 0 ? void 0 : viewModel['parent']) && this._getInjectionContext(viewModel['parent'])));
    }
    _setContextedScopes(request, scope) {
        var _a;
        const injectionContext = (_a = this._getInjectionContext(request === null || request === void 0 ? void 0 : request.$context)) === null || _a === void 0 ? void 0 : _a.id;
    ...
    _setCacheHandler(request, handler) {
        ...
        const key = this._getCacheScopesKey(request);
        map.set(key, handler);
        if ((_a = this._getInjectionContext(request === null || request === void 0 ? void 0 : request.$context)) === null || _a === void 0 ? void 0 : _a.id) {
    ...
    _buildHandlersChain(request) {
        const handlers = this._handlers.filter((h) => {
            ...
            if (!((_a = h.scopes) === null || _a === void 0 ? void 0 : _a.length)) {
                return true;
            }
            return h.scopes.some((s) => { var _a; return (_a = request.scopes) === null || _a === void 0 ? void 0 : _a.includes(s); });
        });
        ...
        const handlerInstances = handlers.map((handlerConfig) => {
            const injectionContext = this._getInjectionContext(request === null || request === void 0 ? void 0 : request.$context);
    ...
    return function (target, method, descriptor) {
        const methodImplementation = function (...args) {
            return HandlerChainService.instance.process({
                type: (config === null || config === void 0 ? void 0 : config.requestType) ? config.requestType : this.requestType,
                method: (config === null || config === void 0 ? void 0 : config.methodName) ? config.methodName : method,
                args,
            });
        };
        if (descriptor) {
...
(_a = global$1.creatio) !== null && _a !== void 0 ? _a : (global$1.creatio = {});
...
class ViewElementRegistry extends ɵBaseRegistry {
    ...
    static getFormControlRelatesAttribute(type) {
        ...
        return (config && 'formControlConfig' in config && ((_a = config.formControlConfig) === null || _a === void 0 ? void 0 : _a.relatesTo)) || null;
    }
}
...
class ValidatorRegistry extends ɵBaseRegistry {
    static _has(configType, type) {
        var _a;
        return ValidatorRegistry.items.has(configType) && ((_a = ValidatorRegistry.items.get(configType)) === null || _a === void 0 ? void 0 : _a.typeRef) !== type;
    }
    static validate(config) {
...
function isComponentPropertyBindable(viewConfigType, componentProperty) {
    ...
    if (!(componentConfig === null || componentConfig === void 0 ? void 0 : componentConfig.inputs)) {
        return false;
    }
    return !!((_a = componentConfig === null || componentConfig === void 0 ? void 0 : componentConfig.inputs[componentProperty]) === null || _a === void 0 ? void 0 : _a.propertyBindable);
}
...
class BaseValidator {
    ...
    static [Symbol.hasInstance](instance) {
        var _a;
        return ((_a = instance === null || instance === void 0 ? void 0 : instance.constructor) === null || _a === void 0 ? void 0 : _a['_instanceOfKey']) === BaseValidator._instanceOfKey;
    }
}
/**
 * @internal
...
class LocalizableValue {
    ...
    static [Symbol.hasInstance](instance) {
        var _a;
        return ((_a = instance === null || instance === void 0 ? void 0 : instance.constructor) === null || _a === void 0 ? void 0 : _a['_instanceOfKey']) === LocalizableValue._instanceOfKey;
    }
}
/**
 * @internal
...
function applyLocalizeMetadataFn(obj, localizeMetadata) {
    ...
    localizableEntries.forEach(({ path, value }) => {
        var _a;
        const localizedValue = (_a = localizeMetadata === null || localizeMetadata === void 0 ? void 0 : localizeMetadata(value.key)) !== null && _a !== void 0 ? _a : value.key;
...
function CrtDesignTimeViewElement(config) {
    return function (type) {
        const registrationConfig = Object.assign(Object.assign({}, config), { typeRef: type });
...
function CrtViewElement(config) {
    return function (type) {
        ...
        const baseRegistrationConfig = Object.assign(Object.assign({}, config), { inputs,
            outputs,
            validationInputs });
        const registrationConfig = 'selector' in config
            ? Object.assign(Object.assign({}, baseRegistrationConfig), { selector: config.selector }) : Object.assign(Object.assign({}, baseRegistrationConfig), { typeRef: type });
...
function CrtInterfaceDesignerItem(config) {
    ...
    return function (type) {
        var _a;
        config.typeRef = type;
        (_a = config.viewElementGroupType) !== null && _a !== void 0 ? _a : (config.viewElementGroupType = ViewElementGroupType.CustomElements);
        _applyTypeCaption();
...
function registerAngularViewElement(config, typeRef) {
    ViewElementRegistry.validate(config);
    ViewElementRegistry.register(Object.assign(Object.assign({}, config), { typeRef }));
}
...
function registerValidators(types, options) {
    resistantForEach(types, (type) => {
        ...
        const registrationConfig = Object.assign(Object.assign({}, metadata), { instantiate: function (injectionContext) {
                const resolveDependency = (options === null || options === void 0 ? void 0 : options.resolveDependency)
...
function registerRequestHandlers(types, options, remoteName) {
    ...
    resistantForEach(types, (type) => {
        ...
        if (options.moduleType === 'host') {
            registrationConfig = Object.assign(Object.assign({}, metadata), { source: { type: HandlerSourceType.Host }, createHandler });
        }
        else {
            const remote = RemoteEntriesRegistry.items.get(remoteName);
            registrationConfig = Object.assign(Object.assign({}, metadata), { source: {
...
function bootstrapDefaultCrtModule(name, type, options) {
    ...
    try {
        ...
        if (moduleDefinition.viewElements) {
            ...
            registerInterfaceDesignerItems(moduleDefinition.viewElements, options === null || options === void 0 ? void 0 : options.localizeMetadata);
        }
        ...
        (_a = moduleDefinition.includes) === null || _a === void 0 ? void 0 : _a.forEach((t) => {
...
function bootstrapCrtModule(...args) {
    ...
    (_b = options.moduleType) !== null && _b !== void 0 ? _b : (options.moduleType = 'remote');
    if (name) {
...
function _bootstrapCrtModuleHandlerChainServices(type) {
    ...
    (_a = moduleDefinition.includes) === null || _a === void 0 ? void 0 : _a.forEach((t) => _bootstrapCrtModuleHandlerChainServices(t));
}
/**
 * @internal
 */
...
class BaseRequestHandler {
    ...
    static [Symbol.hasInstance](instance) {
        var _a;
        return ((_a = instance === null || instance === void 0 ? void 0 : instance.constructor) === null || _a === void 0 ? void 0 : _a['_instanceOfKey']) === BaseRequestHandler._instanceOfKey;
    }
    /**
...
class Model extends BaseHandlerChainService {
    ...
    get name() {
        var _a;
        return (_a = this._crtModel) === null || _a === void 0 ? void 0 : _a.name;
    }
    /**
     * @internal
     */
    ...
    static create(dataSchema) {
        return __awaiter(this, void 0, void 0, function* () {
            const crtModel = yield this.instance._create({
